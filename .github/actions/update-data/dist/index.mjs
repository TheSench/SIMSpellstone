...
const utils_1 = __nccwpck_require__(9271);
/**
 * Commands
 *
 * Command Format:
...
const command_1 = __nccwpck_require__(1567);
const file_command_1 = __nccwpck_require__(1488);
const utils_1 = __nccwpck_require__(9271);
const os = __importStar(__nccwpck_require__(2037));
const path = __importStar(__nccwpck_require__(1017));
const oidc_utils_1 = __nccwpck_require__(5708);
/**
 ...
 * Summary exports
 */
var summary_1 = __nccwpck_require__(2094);
Object.defineProperty(exports, "summary", ({ enumerable: true, get: function () { return summary_1.summary; } }));
/**
 * @deprecated use core.summary
 */
var summary_2 = __nccwpck_require__(2094);
Object.defineProperty(exports, "markdownSummary", ({ enumerable: true, get: function () { return summary_2.markdownSummary; } }));
/**
 * Path exports
 */
var path_utils_1 = __nccwpck_require__(655);
...
const http_client_1 = __nccwpck_require__(7700);
const auth_1 = __nccwpck_require__(9388);
const core_1 = __nccwpck_require__(4561);
class OidcClient {
...
const pm = __importStar(__nccwpck_require__(4303));
const tunnel = __importStar(__nccwpck_require__(7738));
var HttpCodes;
(function (HttpCodes) {
...
var _nil = _interopRequireDefault(__nccwpck_require__(8379));

var _version = _interopRequireDefault(__nccwpck_require__(8080));

var _validate = _interopRequireDefault(__nccwpck_require__(2684));

var _stringify = _interopRequireDefault(__nccwpck_require__(775));

var _parse = _interopRequireDefault(__nccwpck_require__(7507));
...
var _regex = _interopRequireDefault(__nccwpck_require__(5994));
...
/* harmony export */ });
/* unused harmony export pathFromRoot */
...
// EXTERNAL MODULE: ../common/node_modules/@actions/core/lib/core.js
var core = __nccwpck_require__(4561);
...
;// CONCATENATED MODULE: ./src/data/bges.mjs



var bgesJson;

async function getBgesJs() {
...
;// CONCATENATED MODULE: ./src/data/xmlToJson.mjs
...
;// CONCATENATED MODULE: ./src/data/cards.mjs
...
;// CONCATENATED MODULE: ./src/data/mapBges.mjs



var mapBgesJson;

async function getMapBgesJs() {
...
;// CONCATENATED MODULE: ./src/data/helpers.mjs
function addToMap(map) {
  return function(object) {
    map[object.id] = object;
  }
}
;// CONCATENATED MODULE: ./src/data/missionsAndLocations.mjs
...
;// CONCATENATED MODULE: ./src/data/raids.mjs
...
;// CONCATENATED MODULE: ./src/data/runes.mjs



var runesJson;

async function getRunesJs() {
  ...
  Object.keys(object).forEach(function convertProp(key) {
    if (filteredProps[key]) {
      ...
      if (Array.isArray(value)) {
        ...
        object[key] = runes_convertedValue(key, value, {
          attack: parseFloat,
          health: parseFloat,
          cost: parseFloat,
          rarity: parseFloat,
...
function runes_convertedValue(name, originalValue, conversions) {
  return (conversions[name] || (it => it))(originalValue);
}

;// CONCATENATED MODULE: ./src/data/skills.mjs
...
;// CONCATENATED MODULE: ./src/data/spoilers.mjs


var spoilersJson;

async function getSpoilersJs(scriptChanges) {
...
;// CONCATENATED MODULE: ./src/data/updateData.mjs
